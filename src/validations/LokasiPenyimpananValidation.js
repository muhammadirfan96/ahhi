...
const showLokasiPenyimpananValidation = [
  param('id')
    .isMongoId()
    ...
    .custom(async (value, { req }) => {
      try {
        ...
        const data = await LokasiPenyimpananModel.findOne(filter);
...
const findLokasiPenyimpananValidation = [
  query('limit')
    .optional()
    .isInt({ min: 1, max: 100 })
...
export { showLokasiPenyimpananValidation, findLokasiPenyimpananValidation };
