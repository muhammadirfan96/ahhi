...
const showPenerimaanBarangValidation = [
  param('id')
    .isMongoId()
    ...
    .custom(async (value, { req }) => {
      try {
        ...
        const data = await PenerimaanBarangModel.findOne(filter);
...
const findPenerimaanBarangValidation = [
  query('limit')
    .optional()
    .isInt({ min: 1, max: 100 })
...
export { showPenerimaanBarangValidation, findPenerimaanBarangValidation };
